...
def fix_trail_names(df):
    ...
    df["trail_name"] = df["trail_name"].str.replace(",", "")
    df["trail_name"] = df["trail_name"].str.rstrip()
    
    # Correct specific trails
    df.at[15, 'trail_name'] = "Raspberry (Pitch 1)"
    df.at[16, 'trail_name'] = "Raspberry (Pitch 2)"
    df.at[17, 'trail_name'] = "Raspberry (Pitch 3)"
    
    df.at[77, 'trail_name'] = "Zipper 1"
    df.at[78, 'trail_name'] = "Zipper 2"
    df.at[79, 'trail_name'] = "Zipper 3"
    
    return df

if __name__ == '__main__':

    df_resort = make_dataframe("../../data/resorts/Taos.txt")

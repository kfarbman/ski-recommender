...
def fix_trail_names(df):
    ...
    df.loc[df["trail_name"] == '. Six Shooter', "trail_name"] = "Six Shooter"
    df.loc[df["trail_name"] == '-L Lower Lillie G', "trail_name"] = "Lower Lillie G"
    df.loc[df["trail_name"] == '-U Upper Lillie G', "trail_name"] = "Upper Lillie G"
    
    return df

if __name__ == '__main__':

    df_resort = make_dataframe("../../data/resorts/Copper.txt")
